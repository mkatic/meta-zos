...
DEPENDS = "virtual/libsdl xsp zlib libpng jpeg freetype fontconfig alsa-lib lzo ncurses \
           libmad"
...
LICENSE = "GPLv2"
LIC_FILES_CHKSUM="file://LICENSE;md5=3a1c930887ac5f4b52872945f2655680"
...
EXTRA_OECONF_append = " ${@base_contains('MACHINE_FEATURES', 'iwmmxt', '--enable-pxa', '',d)} "
