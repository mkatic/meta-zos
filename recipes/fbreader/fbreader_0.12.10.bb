...
DEPENDS = "gtk+ expat bzip2 virtual/libiconv liblinebreak libfribidi curl"

SRC_URI = "http://www.fbreader.org/files/sources/fbreader-sources-0.12.10.tgz \
file://Makefile.patch \
file://gcc45.patch"
	   
# Set the defaults
READER_RESOLUTION ?= "640x480"
READER_ARCH       ?= "zaurus"
READER_UI         ?= "gtk"
